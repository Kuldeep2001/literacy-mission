...
export default function NavbarItem(props) {
  ...
  return (
    ...
    onMouseEnter={()=>{setHoverColor("light"); setTextColor("dark");}}
    onMouseLeave={()=>{setHoverColor("transparent"); setTextColor("light"); console.log(props.theme); console.log(textColor) }}>
